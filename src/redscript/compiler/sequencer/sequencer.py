...
class KinematicSequencer:
    ...
    def _get_component_type(self, type_str: str) -> ComponentType:
        ...
        type_map = {
            ...
            'NoteBlock': ComponentType.NOTE_BLOCK,
            'DaylightDetector': ComponentType.DAYLIGHT_DETECTOR,
            'TripwireHook': ComponentType.TRIPWIRE_HOOK,
            'TrappedChest': ComponentType.TRAPPED_CHEST,
            'Dispenser': ComponentType.DISPENSER,
            'TNT': ComponentType.TNT,
            'Lectern': ComponentType.LECTERN,
            'Bell': ComponentType.BELL,
            'LightningRod': ComponentType.LIGHTNING_ROD,
            'SculkSensor': ComponentType.SCULK_SENSOR,
            'CalibratedSculkSensor': ComponentType.CALIBRATED_SCULK_SENSOR,
            'DetectorRail': ComponentType.DETECTOR_RAIL,
            'PoweredRail': ComponentType.POWERED_RAIL,
            'ActivatorRail': ComponentType.ACTIVATOR_RAIL,
            'IronDoor': ComponentType.IRON_DOOR,
            'OakDoor': ComponentType.OAK_DOOR,
            'IronTrapdoor': ComponentType.IRON_TRAPDOOR,
            'OakTrapdoor': ComponentType.OAK_TRAPDOOR,
            'OakFenceGate': ComponentType.OAK_FENCE_GATE,
            ...
            'glass': ComponentType.GLASS,
            'note_block': ComponentType.NOTE_BLOCK,
            'daylight_detector': ComponentType.DAYLIGHT_DETECTOR,
            'tripwire_hook': ComponentType.TRIPWIRE_HOOK,
            'trapped_chest': ComponentType.TRAPPED_CHEST,
            'dispenser': ComponentType.DISPENSER,
            'tnt': ComponentType.TNT,
            'lectern': ComponentType.LECTERN,
            'bell': ComponentType.BELL,
            'lightning_rod': ComponentType.LIGHTNING_ROD,
            'sculk_sensor': ComponentType.SCULK_SENSOR,
            'calibrated_sculk_sensor': ComponentType.CALIBRATED_SCULK_SENSOR,
            'detector_rail': ComponentType.DETECTOR_RAIL,
            'powered_rail': ComponentType.POWERED_RAIL,
            'activator_rail': ComponentType.ACTIVATOR_RAIL,
            'iron_door': ComponentType.IRON_DOOR,
            'oak_door': ComponentType.OAK_DOOR,
            'iron_trapdoor': ComponentType.IRON_TRAPDOOR,
            'oak_trapdoor': ComponentType.OAK_TRAPDOOR,
            'oak_fence_gate': ComponentType.OAK_FENCE_GATE,
        }
