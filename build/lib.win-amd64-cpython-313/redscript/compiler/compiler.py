    ...
    def _place_components(self, graph: LogicalGraph) -> VoxelGrid:
        ...
        for i, component in enumerate(component_list):
            ...
            for (offset, material, props) in blocks:
                ...
                merged_props = {**props}
                if 'facing' in component.properties:
                    merged_props['facing'] = component.properties['facing']
                
                block = Block(material=material, properties=merged_props)
                grid.set_block(bx, by, bz, block)
                
                # Place supporting block underneath pistons/repeaters
                if 'piston' in material or 'repeater' in material:
